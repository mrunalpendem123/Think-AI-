...
// Import AVAILABLE_MODELS from store to ensure single source of truth
import { AVAILABLE_MODELS } from "@/stores/webllm";
    ...
    const loadModel = async (modelId: string) => {
        ...
        try {
            ...
            if (isLocal) {
                ...
                if (customRecord) {
                    console.log("Injecting custom appConfig with record:", customRecord);
